...
export const runOpenAi = async (client: OpenAI, { modelName, prompt, systemPrompt, llmConfig, images }: Pick<LLMPromptParams, 'modelName' | 'prompt' | 'systemPrompt' | 'llmConfig' | 'images'>) => {
